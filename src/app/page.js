...
import { Store, UserCircle, Star, ArrowLeft, PlusCircle, Video, Trash2, Edit, LogOut, ShieldCheck, ChevronDown, ChevronUp, X, Eye, Search, Users, EyeOff, Download, Type, FileText, Sparkles, Tag, ImageIcon, CheckCircle2, ChevronRight, AlertTriangle } from 'lucide-react';
...
export default function App() {
  ...
  const renderView = () => {
    ...
    switch (view.page) {
      ...
      case 'dashboard':
          // Viewers cannot access dashboard. Super admins route to /admin via the Header link.
          if (isViewerUser) {
