...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase.js [app-client] (ecmascript)"); // Import centralized services
...
_c = StarRating;
const Header = (param)=>{
    let { setView, searchTerm, setSearchTerm, user } = param;
    const goHome = ()=>{
        setSearchTerm('');
        setView({
            page: 'home'
...
_s1(ProductPage, "WXpFoGahLQNZFVAgifhCTdJtShw=");
_c6 = ProductPage;
const VendorLogin = ()=>{
    _s2();
    ...
    const handleSignUp = async (e)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], formatEmail(username), password);
        } catch (err) {
    ...
    const handleSignIn = async (e)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], formatEmail(username), password);
        } catch (err) {
            setError(err.message);
        }
    };
...
_s2(VendorLogin, "lABZ+K3zbnEaFQvlduiFXLNOf5A=");
_c7 = VendorLogin;
const CreateProductForm = (param)=>{
    ...
    const handleFileUpload = (file, fileType)=>{
        ...
        const fileRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"], "".concat(folder, "/").concat(Date.now(), "_").concat(file.name));
    ...
    const handleSaveProduct = async (e)=>{
        ...
        try {
            ...
            if (editingProduct) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "products", editingProduct.id), commonData);
                setSuccess('Product updated successfully!');
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "products"), {
                    ...commonData,
                    vendorId: user.uid,
...
_s3(CreateProductForm, "VbnMA/G7RLDf/dpPR1V5nFtX0FM=");
_c8 = CreateProductForm;
const VendorDashboard = (param)=>{
    let { setVendorView, user, setView, onEditProduct } = param;
    _s4();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VendorDashboard.useEffect": ()=>{
            if (user) {
                const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "products"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])("vendorId", "==", user.uid));
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                    "VendorDashboard.useEffect.unsubscribe": (snapshot)=>{
                        const prods = [];
                        snapshot.forEach({
                            "VendorDashboard.useEffect.unsubscribe": (doc)=>prods.push({
                                    id: doc.id,
                                    ...doc.data()
                                })
...
const VendorArea = (param)=>{
    let { setView, user } = param;
    _s5();
    const [vendorView, setVendorView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('dashboard');
...
_s5(VendorArea, "qnmFECCu8PqwPxRF72O30h9wHeM=");
_c10 = VendorArea;
function App() {
    _s6();
        ...
        "App.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "products"), {
                "App.useEffect.unsubscribe": (snapshot)=>{
                    const prods = [];
                    snapshot.forEach({
                        "App.useEffect.unsubscribe": (doc)=>prods.push({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["App.useEffect.unsubscribe"]);
        ...
        "App.useEffect": ()=>{
            if (searchTerm.trim() === '') {
                ...
                const results = allProducts.filter({
                    "App.useEffect.results": (p)=>p.name.toLowerCase().includes(lowercasedQuery) || p.subtitle && p.subtitle.toLowerCase().includes(lowercasedQuery) || p.tags && p.tags.some({
                            "App.useEffect.results": (t)=>t.toLowerCase().includes(lowercasedQuery)
                        }["App.useEffect.results"]) || p.vendor && p.vendor.toLowerCase().includes(lowercasedQuery) || p.shortDescription && p.shortDescription.toLowerCase().includes(lowercasedQuery)
...
_s6(App, "fur3q4diPaAlp1jGC5yQ685zE24=");
_c11 = App;
...
//# sourceMappingURL=src_3044384f._.js.map